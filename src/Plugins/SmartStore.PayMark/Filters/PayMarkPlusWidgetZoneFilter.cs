...
{
    public class PayMarkPlusWidgetZoneFilter : IResultFilter
	{
		private readonly Lazy<IWidgetProvider> _widgetProvider;

        public PayMarkPlusWidgetZoneFilter(Lazy<IWidgetProvider> widgetProvider)
		{
		...
		public void OnResultExecuting(ResultExecutingContext filterContext)
		{
			...
			{
                _widgetProvider.Value.RegisterAction("checkout_completed_top", "CheckoutCompleted", "PayMarkPlus", new { area = Plugin.SystemName });
			}
		}

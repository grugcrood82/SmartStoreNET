...
{
    public class PayMarkDirectPaymentInfoModel : ModelBase
    {
        public PayMarkDirectPaymentInfoModel()
        {
    ...
    public class PaymentInfoValidator : AbstractValidator<PayMarkDirectPaymentInfoModel>
    {
